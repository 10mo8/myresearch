...
#最終4層のCLSトークンの出力をconcatしたものをニューラルネットワークの入力にします
#BERTの最終層とニューラルネットワークをfinetuning
import numpy as np
import pandas as pd
import pickle
